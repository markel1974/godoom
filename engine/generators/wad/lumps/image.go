...
// Image represents a 2D bitmap with a specified width, height, and raw pixel data.
type Image struct {
	Width  int
	Height int
	Pixels []byte
...
// NewImage reads a lump from the file, decodes it into an image, and applies transparency using the given palette index.
