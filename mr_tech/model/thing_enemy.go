...
func (t *ThingEnemy) GetCeilY() float64 {
...
func (t *ThingEnemy) MoveApply(tx float64, ty float64) {
...
func (t *ThingEnemy) MoveEntityApply() {
...
func (t *ThingEnemy) clipMovement(velX float64, velY float64) (float64, float64) {
